...
# calibration Initial distance set to 400 mm ie 40 cm
# avg value for object =  1500 - 1700 in disparity map avg 1600
# Taking constant of proportionality as 400/1600 = 0.25
